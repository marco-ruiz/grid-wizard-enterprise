 ...
 * @since Mar 1, 2009
 */
public class BsubDriver extends CommandLineResourceManagerDriver {

	private static Log log = LogFactory.getLog(BsubDriver.class);
    private static Pattern pattern = Pattern.compile("Your job (\\d+) .* has been submitted");

	public BsubDriver() { super("bjobs", "bsub", "rm-bsub.vm"); }
