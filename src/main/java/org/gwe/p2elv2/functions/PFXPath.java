 ...
 * @since Aug 11, 2008
 */
public class PFXPath extends PFunction {

	private static Log log = LogFactory.getLog(PFXPath.class);

	public PFXPath() { super("xpath"); }
...
//    	params.add("<catalog><entries><entry URI=\"uri2\">content2</entry><entry URI=\"uri3\">content3</entry><entry URI=\"uri4\">content4</entry></entries></catalog>");
    	...
    	String xml = "<ResultSet title=\"Scans\"><results><columns><column>ID</column><column>Name</column><column>Size</column><column serverRoot=\"\">URI</column></columns>" + 
    	"<rows>" + 
